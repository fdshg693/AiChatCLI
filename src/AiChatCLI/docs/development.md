...
- `Agents/`: agent 定義、tool catalog、OpenAI agent factory、sub-agent 実行、command / read_file / memory / skill / search tool
- `Skills/`: `skills/*/SKILL.md` の front matter / markdown 解析、skill metadata の prompt 注入
